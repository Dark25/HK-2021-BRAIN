                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" form name="mygallery" action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1" value="<?php echo $_SESSION['slogan']; ?>" name="slogan">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <center>
                                            <img style="border-radius: 6px;" src="<?= $config['hotelUrl']; ?>/adminpan/img/newsimages/choose.gif" name="topstory" width="500" border=0>
                                        </center>
                                    </div>
                                </div>
                                <center>
