            ...
            <div class="row">
				...
				?>	<input type="hidden" name="id" value="<?php echo admin::EditNews("id"); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1" value="<?php echo admin::EditNews("shortstory"); ?>" name="shortstory">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <center>
                                            <img style="border-radius: 6px;" href="javascript:linkrotate(document.mygallery.topstory.selectedIndex)" name="topstory" width="500" border=0>
                                        </center>
                                    </div>
                                </div>
                                <center>
