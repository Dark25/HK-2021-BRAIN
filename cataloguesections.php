                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr style="color:#6c7293; background:#191c24">
                                                    ...
                                                    <td><img src="https://swfs.hionix.es/c_images/catalogue/icon_<?php echo $pages["icon_image"]; ?>.png" /> (<?php echo $pages["icon_image"]; ?>)</td>
                                                    <td><?php echo $pages["caption"]; ?></td>
                                                    <td>
                                                        <center><a type="button" class="btn btn-info" href="<?php echo $config['hotelUrl']; ?>/adminpan/cataloguesections/edit/<?php echo $pages["id"]; ?>">Editar</center></a>
                                                    </td>
                                                    <td>
                                                        <center><a type="button" class="btn btn-danger" href='<?php echo $config['hotelUrl']; ?>/adminpan/cataloguesections/delete/<?php echo $pages["id"]; ?>'>Eliminar</center></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
