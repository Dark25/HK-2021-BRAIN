<head>
    	...
    	<link rel="stylesheet" href="<?= $config['hotelUrl'];?>/templates/core/views/css/materialize.min.css">
		<link rel="stylesheet" href="<?= $config['hotelUrl'];?>/templates/core/views/css/styles.css">
